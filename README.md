...
- La Fase 03 no se sube de forma persistente porque su entrada cambia segun la columna y el tipo
...
- usa `DEP_DELAY`;
- pide un umbral firmado:
  - positivo o cero para retrasos;
...
- pide un umbral firmado;
- el umbral se copia a **memoria constante**;
...
- `main.cu` gestiona la consola, guarda el dataset y construye el dataset persistente en GPU.
